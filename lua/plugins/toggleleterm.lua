return {
    ...
    config = function ()
        ...
        vim.keymap.set("n", "<leader>mh", function() horizontal_term:toggle() end, { desc = "Terminal horizontal" })
        vim.keymap.set("n", "<leader>mv", function() vertical_term:toggle() end,   { desc = "Terminal vertical" })
        vim.keymap.set("n", "<leader>mf", function() float_term:toggle() end,     { desc = "Terminal float" })
    end
}
